    ...
    <div class="login-shell">
      <div class="login-card">
        <section class="login-hero">
          ...
          <p>Base modular por carpetas con login, permisos, ventas, inventario, bodega, clientes, web y mayoreo estable.</p>
          <div class="login-list">
            <div>🔐 Acceso por usuario y contraseña</div>
            <div>🧩 Permisos por módulo controlados por admin</div>
            <div>📦 Inventario y mayoreo separados</div>
...
function openRoute(route) {
  ...
  if (route !== 'mayoreo_historial') state.selectedMayoreoSaleId = '';
  render();
}
